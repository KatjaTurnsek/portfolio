...
export const projects = [
  // WEBSITES
  {
    ...
    stack: 'UX/UI Design | React | API Integration',
    desc: 'Responsive booking experience for finding stays, making bookings, and managing venues.',
...

  {
    ...
    stack: 'UI Design | JavaScript | API Integration',
    desc: 'Auction platform that makes creating listings, placing bids, and managing profiles straightforward.',
...

  {
    ...
    stack: 'E-commerce | React | TypeScript',
    desc: 'Responsive shopping experience with simple product discovery, cart management, and checkout.',
...

  {
    ...
    stack: 'Art Direction | Front-End Development | GSAP',
    desc: 'A custom portfolio bringing design, development, and motion together in one responsive experience.',
...

  {
    ...
    stack: 'Brand Identity | Web Design | SEO',
    desc: 'Real-business website designed to present portrait commissions clearly and improve online visibility.',
...

  {
    ...
    stack: 'Brand Identity | Web Design | JavaScript',
    desc: 'Responsive community website combining a playful visual identity with API-managed content.',
  ...
  // WEB & INTERACTION DESIGN
  {
    ...
    stack: 'UX/UI Design | Interaction Design | Figma',
    desc: 'Responsive booking flows for guests and venue managers, supported by a consistent interface system.',
...

  {
    ...
    stack: 'UX/UI Design | Design System | Figma',
    desc: 'Clear auction flows and reusable interface components for browsing, bidding, and creating listings.',
...

  {
    ...
    stack: 'Web Design | Responsive Prototyping | Figma',
    desc: 'Art-focused website design that presents portrait commissions clearly across desktop and mobile.',
...

  {
    ...
    stack: 'Art Direction | Interaction Design | Figma',
    desc: 'A liquid-inspired design system created to give the portfolio a distinctive and cohesive experience.',
...

  {
    ...
    stack: 'Brand Identity | Web Design | Figma',
    desc: 'Responsive blog design that carries the playful community identity through every screen.',
...

  {
    ...
    stack: 'E-commerce | UX/UI Design | Figma',
    desc: 'Responsive shopping flow designed to make product discovery, selection, and checkout easy to follow.',
  ...
  // LOGOTYPES / GRAPHIC DESIGN
  {
    ...
    stack: 'Brand Identity | Logo Design | Cover Art',
    desc: 'A flexible logo suite and single artwork giving the band a consistent identity across its releases.',
...

  {
    ...
    stack: 'Children’s Illustration | Visual Storytelling | Photoshop',
    desc: 'A published children’s book developed from pencil sketches into warm, expressive digital illustrations.',
...

  {
    group: 'logina',
    caseId: 'logina',
    title: 'Logina - Visual & Digital Design',
    stack: 'Visual Communication | Touchscreen UI | Illustration',
    desc: 'Touchscreen interfaces, product materials, and illustrations created to make technical information easier to understand.',
...

  {
    ...
    stack: 'Brand Identity | Logo Design | Illustration',
    desc: 'A hand-drawn portrait mark refined into a flexible logo that connects directly to the custom pet art.',
...

  {
    ...
    stack: 'Brand Identity | Logo Design | Figma',
    desc: 'A flexible identity created to work consistently across the auction interface and supporting brand materials.',
...

  {
    ...
    stack: 'Brand Identity | Logo Design | Illustrator',
    desc: 'A fluid initials mark reflecting the connection between visual design and front-end development.',
