 ...
 *              Safari fallbacks, menu interactions, and per-section effects.
 */
...
/**
 * Hides animated wave canvases and shows static fallbacks on Safari.
 * Improves performance and avoids rendering glitches.
 */
...
/**
 * Applies `will-change` to frequently animated elements (Safari only).
 */
...
/**
 * Sequential blur→sharp + fade-in for loaded images.
...
/**
 * Runs per-section effects when a section becomes visible.
 * Listens for the custom `sectionVisible` event from reveal logic.
 */
...
/** Animates menu waves and links when the fullscreen menu opens. */
...
/** Prevents accidental text selection during drag/touch interactions. */
...
/** Boot sequence after DOM is ready. */
document.addEventListener("DOMContentLoaded", () => {
  ...
  // Simulate initial load duration; hide loader, then animate chrome + blobs
  setTimeout(() => {
    hideLoader();
