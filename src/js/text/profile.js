...
export const isSafari =
  /Safari/.test(ua) && !/Chrome|CriOS|FxiOS|Edg|EdgiOS/.test(ua);
...
export const RICH_MOBILE =
  FORCE_RICH || (HW_THREADS >= 4 && !prefersReducedMotion());
...
export const LONG_P_THRESHOLD =
  RICH_MOBILE && !prefersReducedMotion()
    ? 999
